...
class TestHarryPotter(unittest.TestCase):
    def test_calculate_discount(self):
        ...
        self.assertEqual(single_book_discount, SINGLE_BOOK_PRICE * (SINGLE_BOOK_DISCOUNT_RATE + 1))
        self.assertEqual(two_books_discount, SINGLE_BOOK_PRICE * (TWO_BOOKS_DISCOUNT_RATE + 1) * 2)
        self.assertEqual(three_books_discount, SINGLE_BOOK_PRICE * (THREE_BOOKS_DISCOUNT_RATE + 1) * 3)
        self.assertEqual(four_books_discount, SINGLE_BOOK_PRICE * (FOUR_BOOKS_DISCOUNT_RATE + 1) * 4)
        self.assertEqual(five_books_discount, SINGLE_BOOK_PRICE * (FIVE_BOOKS_DISCOUNT_RATE + 1) * 5)